const moviesMock = [
  ...
  },
  {
    ...
    description:
      'Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectu .Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.',
    duration: 1968,
    contentRating: 'NC-17',
    source:
...
class MoviesServiceMock {
  ...
  async createMovie() {
    return new Promise.resolve(moviesMock[0]);
  }
}
